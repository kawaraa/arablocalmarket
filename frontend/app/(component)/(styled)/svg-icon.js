...
const icons = {
  ...
  logo: (
    <svg
      ...
      fill="#aea1ea"
      aria-hidden="true">
      <path fill="#9bface" d="M126.4,361.712v-176.44h258.08v176.44H126.4z" />
      <rect x="96" y="361.68" width="319.016" height="19.952" />
      <rect x="215.24" y="269.44" width="80.4" height="92.28" />
      <path d="M96.8,149v48.24c0,22.04,17.864,39.904,39.904,39.904s39.904-17.864,39.904-39.904 c0,22.04,17.864,39.904,39.904,39.904s39.904-17.864,39.904-39.904c0.016,22.04,17.888,39.896,39.928,39.88 c22.024-0.016,39.864-17.864,39.88-39.88c0.016,22.04,17.888,39.896,39.928,39.88c22.024-0.016,39.864-17.864,39.88-39.88V149 L96.8,149L96.8,149z" />
      <polygon points="147.776,98.336 96.776,149 416,149 365,98.336 " />
    </svg>
  ),
  store: (
    <svg
      ...
      />
      <path fill="#9bface" d="M200,201.11H56a12,12,0,0,1-12-12l0-108H212l0,108A12,12,0,0,1,200,201.11Z" />
      <path
        fill="#8be5bb"
      ...
      />
      <path fill="#eceaf6" d="M232,81.1H24l16.55-31A12,12,0,0,1,51,44H205a12,12,0,0,1,10.43,6.06Z" />
      <path
        fill="#ffffff"
      ...
      />
      <rect fill="#eceaf6" x="119.31" y="147.55" width="75.63" height="36.32" rx="6" ry="6"></rect>
      <rect fill="#ffffff" x="119.31" y="154.77" width="75.63" height="29.1" rx="6" ry="6"></rect>
      <path
        fill="#aea1ea"
      ...
      />
      <circle fill="#d4ffd4" cx="232" cy="134" r="5"></circle>
      <circle fill="#d4ffd4" cx="144" cy="29" r="4"></circle>
      <circle fill="#d4ffd4" cx="125" cy="224" r="3"></circle>
      <circle fill="#d4ffd4" cx="31" cy="131" r="2"></circle>
      <circle fill="#d4ffd4" cx="38" cy="211" r="1"></circle>
      <circle fill="#ffbdbd" cx="66" cy="227" r="5"></circle>
      <circle fill="#ffbdbd" cx="112" cy="28" r="4"></circle>
      <circle fill="#ffbdbd" cx="16" cy="72" r="3"></circle>
      <circle fill="#ffbdbd" cx="232" cy="209" r="2"></circle>
      <circle fill="#ffbdbd" cx="240" cy="116" r="1"></circle>
      <circle fill="#bbf1ff" cx="221" cy="21" r="5"></circle>
      <circle fill="#bbf1ff" cx="12" cy="130" r="4"></circle>
      <circle fill="#bbf1ff" cx="5" cy="172" r="3"></circle>
      <circle fill="#bbf1ff" cx="77" cy="30" r="2"></circle>
      <circle fill="#bbf1ff" cx="35" cy="33" r="1"></circle>
      <circle fill="#fff4c5" cx="249" cy="39" r="5"></circle>
      <circle fill="#fff4c5" cx="199" cy="236" r="4"></circle>
      <circle fill="#fff4c5" cx="21" cy="212" r="3"></circle>
      <circle fill="#fff4c5" cx="178" cy="37" r="2"></circle>
      <circle fill="#fff4c5" cx="228" cy="195" r="1"></circle>
    </svg>
  ),
  foodDeliverBike: (
    <svg
