...
export default function Button({ text, icon, type = "button", handler, loading, disabled, cls, iconCls }) {
  let c = `inline-flex justify-center px-3 py-1 text-sm md:text-lg bg-pc bg-gradient-to-tl text-t font-medium rounded-md shadow-md md:px-4 md:py-2 disabled:opacity-60 disabled:cursor-no-drop duration-200 `;
