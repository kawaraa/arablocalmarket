...
export interface ApiAffiliateAffiliate extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    referredItem: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
...
export interface ApiBankBank extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    confirmed: Schema.Attribute.Boolean & Schema.Attribute.Required & Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::bank.bank"> & Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<["pending", "open", "completed"]> &
      Schema.Attribute.Required &
...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cart: Schema.Attribute.Component<"product.cart-item", true>;
    contacts: Schema.Attribute.Relation<"oneToMany", "api::contact.contact">;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    favoriteProducts: Schema.Attribute.Relation<"manyToMany", "api::product.product">;
    favoriteStores: Schema.Attribute.Relation<"manyToMany", "api::store.store">;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    workStores: Schema.Attribute.Relation<"manyToMany", "api::store.store">;
  };
}
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bank: Schema.Attribute.Relation<"manyToOne", "api::bank.bank"> & Schema.Attribute.Private;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::invoice.invoice"> & Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<["PENDING", "PAYABLE", "PAID"]> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"PENDING">;
    stripeInvoices: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 20;
      }>;
...
export interface ApiNotificationNotification extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    seen: Schema.Attribute.Boolean & Schema.Attribute.Required & Schema.Attribute.DefaultTo<false>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    lineItems: Schema.Attribute.Component<"product.line-item", true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
    ...
    status: Schema.Attribute.Enumeration<
      ["PENDING", "PAID", "FAILED", "CANCELED", "READY", "SENT", "DELIVERED", "RETURNED", "ARCHIVED"]
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"PENDING">;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    favorites: Schema.Attribute.Relation<"manyToMany", "api::customer.customer">;
...
export interface ApiRatingRating extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    customer: Schema.Attribute.Relation<"manyToOne", "api::customer.customer">;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::rating.rating"> & Schema.Attribute.Private;
...
export interface ApiStoreStore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    address: Schema.Attribute.Component<"user-information.address", false> & Schema.Attribute.Required;
    cocNumber: Schema.Attribute.String;
    cover: Schema.Attribute.Media<"images">;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    currency: Schema.Attribute.Enumeration<
      ["$-USD", "\u20AC-EUR", "\u00A3-GBP", "$-AUD", "$-CAD", "CHF-CHF", "\u20BA-TRY"]
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"\u20AC-EUR">;
    deliver: Schema.Attribute.Boolean & Schema.Attribute.Required & Schema.Attribute.DefaultTo<false>;
    ...
    favorites: Schema.Attribute.Relation<"manyToMany", "api::customer.customer">;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::store.store"> & Schema.Attribute.Private;
    meta: Schema.Attribute.JSON;
    name: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    open: Schema.Attribute.Boolean & Schema.Attribute.Required & Schema.Attribute.DefaultTo<false>;
    openingHours: Schema.Attribute.Component<"user-information.opening-hours", true> &
      Schema.Attribute.SetMinMax<
        {
          max: 7;
          min: 0;
    ...
    payments: Schema.Attribute.Component<"user-information.payment-method", true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
    ...
    publishedAt: Schema.Attribute.DateTime;
    ratings: Schema.Attribute.Relation<"oneToMany", "api::rating.rating">;
    subscriptionId: Schema.Attribute.String & Schema.Attribute.Private & Schema.Attribute.Unique;
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"MARKET">;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    vatNumber: Schema.Attribute.String;
    whatsAppOrder: Schema.Attribute.Boolean & Schema.Attribute.Required & Schema.Attribute.DefaultTo<true>;
    workers: Schema.Attribute.Relation<"manyToMany", "api::customer.customer">;
  };
}
...
export interface PluginUsersPermissionsUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    address: Schema.Attribute.Component<"user-information.address", false>;
    affiliates: Schema.Attribute.Relation<"oneToMany", "api::affiliate.affiliate">;
    ...
    lastName: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<"Surname">;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    warnings: Schema.Attribute.Component<"user-information.warning", true>;
  };
}
